...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Sign in &middot; Hack Bootstrap</title>
  ...
  <div class="front-card">
    ...
    <div class="front-signin">
      <form action="checkLogin.jsp" class="signin" method="get">
        <div class="placeholding-input username hasome">
          <input type="text" class="text-input email-input" name="username" title="Username" autocomplete="on" tabindex="1" placeholder="Username">
        </div>
    ...
    <div class="front-signup">
      ...
      <form action="newLogin.jsp" class="signup" method="get">
        <div class="name">
        ...
        <div class="username">
          <input type="text" id="signup-user-username" autocomplete="off" maxlength="20" name="username" placeholder="Username">
        </div>
        <div class="password">
          <input type="password" id="signup-user-password" autocomplete="off" maxlength="20" name="password" placeholder="Password">
        </div>
        <div class="school">
          <input type="text" id="signup-user-school" autocomplete="off" maxlength="32" name="school" placeholder="School">
        </div>
        <div class="grade">
          <input type="text" id="signup-user-grade" autocomplete="off" maxlength="2" name="grade" placeholder="Grade">
        </div>
